...
export class JhiAlertErrorComponent implements OnDestroy {
  ...
  constructor(private alertService: JhiAlertService, private eventManager: JhiEventManager, translateService: TranslateService) {
    ...
    this.cleanHttpErrorListener = eventManager.subscribe('jhipsterSampleMonolithApplicationApp.httpError', response => {
      let i;
          ...
          if (errorHeader) {
            ...
            for (i = 0; i < fieldErrors.length; i++) {
              ...
              const fieldName = translateService.instant(
                'jhipsterSampleMonolithApplicationApp.' + fieldError.objectName + '.' + convertedField
              );
