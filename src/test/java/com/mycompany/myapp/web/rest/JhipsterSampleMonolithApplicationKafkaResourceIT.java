...
import com.mycompany.myapp.JhipsterSampleMonolithApplicationApp;
...
public class JhipsterSampleMonolithApplicationKafkaResourceIT {
    ...
    @Autowired
    private JhipsterSampleMonolithApplicationKafkaProducer producer;

    @Autowired
    private JhipsterSampleMonolithApplicationKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        JhipsterSampleMonolithApplicationKafkaResource kafkaResource = new JhipsterSampleMonolithApplicationKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/jhipster-sample-monolith-application-kafka/publish?message=test"))
